 ...
 * Jedis client.
 */
public class RedisElastiCacheDemo {
    ...
    /**
     * Is tls in transit enabled for the cluster
     */
     ...
     */
    public RedisElastiCacheDemo() throws IOException {
        initialize();
    }
    ...
    private void loadProperties() throws IOException {
        ...
        useSSL = Boolean.parseBoolean(properties.getProperty("REDIS_USE_SSL"));
        authToken = properties.getProperty("REDIS_AUTH_TOKEN");
    ...
    private void startClient() throws IOException {
        ...
        jedis = new Jedis(redisHost, redisPort, clientTimeoutInSecs, useSSL);
        // AUTH if necceesary
        if (useSSL) {
     ...
     * 2. Instantiates the Jedis client.
